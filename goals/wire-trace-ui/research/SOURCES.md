...
- **Cluster and origin:** the research sweep of 2026-09-18, carried into this
  goal at graduation. Six web searches
...
- **Primary ledger:** the source exploration's
  [`research/SOURCES.md`](../../../explorations/wire-trace-ui/research/SOURCES.md),
  backed by its
  [`RESEARCH.md`](../../../explorations/wire-trace-ui/RESEARCH.md). This file
  reproduces the corpus for implementation; the exploration copy stays
  authoritative for provenance.
- No mined code corpus, so section 1 is dropped per the rules above.
...
- Source exploration:
  [`explorations/wire-trace-ui/`](../../../explorations/wire-trace-ui/). Its
  [`BRIEF.md`](../../../explorations/wire-trace-ui/BRIEF.md) seeded this
  packet's objective, non-goals and constraints, its
  [`MAP.md`](../../../explorations/wire-trace-ui/MAP.md) seeded the phases, and
  its [`DECISIONS.md`](../../../explorations/wire-trace-ui/DECISIONS.md) holds
  every decision with its rejected alternatives.
- Sibling packet: [`goals/wire-trace-cli/`](../../wire-trace-cli/), which built
  the tracer and both CLIs this goal records from.
