# Typed Subscriptions — Sources & Provenance

- **Source exploration:** `explorations/typed-mids`. Primary ledger:
  [`explorations/typed-mids/research/SOURCES.md`](../../../explorations/typed-mids/research/SOURCES.md).
  This copy is reproduced at graduation (2026-09-19) for implementation
  convenience. If the two disagree, the exploration's ledger wins.
- **Provenance:** claims are carried by
  [`explorations/typed-mids/RESEARCH.md`](../../../explorations/typed-mids/RESEARCH.md).
...
- <https://github.com/Rickedb/OpenProtocolInterpreter> — exploration RESEARCH.md §External Landscape
...
- <https://github.com/st-one-io/node-red-contrib-open-protocol> — exploration RESEARCH.md §Constraints Discovered
...
- Source exploration: [`explorations/typed-mids/`](../../../explorations/typed-mids/),
  with [`DECISIONS.md`](../../../explorations/typed-mids/DECISIONS.md),
  [`BRIEF.md`](../../../explorations/typed-mids/BRIEF.md) and
  [`MAP.md`](../../../explorations/typed-mids/MAP.md).
- Prerequisite goal: [`../../typed-mid-definitions/`](../../typed-mid-definitions/).
- Decision summary: [`../SPEC.md`](../SPEC.md) §Decisions.
