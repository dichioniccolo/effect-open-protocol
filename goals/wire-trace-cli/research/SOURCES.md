...
- **Cluster and origin:** the research sweep of 2026-09-18, carried into this
  goal at graduation. Three web searches, covering latency injection, the Effect
  v4 CLI, and Open Protocol tooling, plus a targeted in-repo inventory of
  `src/**`, `simulator/**`, `demo/**` and `test/**`.
- **Primary ledger:** the source exploration's
  [`research/SOURCES.md`](../../../explorations/wire-trace-cli/research/SOURCES.md),
  backed by its
  [`RESEARCH.md`](../../../explorations/wire-trace-cli/RESEARCH.md). This file
  reproduces the corpus for implementation; the exploration copy stays
  authoritative for provenance.
- No mined code corpus, and no upstream repo is vendored or ported, so sections
  1 and 2 are dropped per the rules above.
...
- Source exploration:
  [`explorations/wire-trace-cli/`](../../../explorations/wire-trace-cli/). Its
  [`BRIEF.md`](../../../explorations/wire-trace-cli/BRIEF.md) seeded this
  packet's objective and non-goals, its
  [`MAP.md`](../../../explorations/wire-trace-cli/MAP.md) seeded the phases, and
  its [`DECISIONS.md`](../../../explorations/wire-trace-cli/DECISIONS.md) holds
  every decision with its rejected alternatives.
- Sibling packet:
  [`goals/effect-open-protocol/`](../../effect-open-protocol/), which produced
  the library these commands drive.
