# Effect SQL Model Instead Of Raw SQL — Sources & Provenance

- **Cluster / origin:** a 2026-09-20 research sweep over the Effect v4 reference
  checkout (`.repos/effect`, linked by `scripts/setup-effect-ref.sh`) plus the
  repo's own store/CLI/UI SQL surface.
...
[`../RESEARCH.md`](../RESEARCH.md) § "2026-09-20 — External landscape".
...
- Goal graduated from this packet: [`goals/trace-schema-models`](../../../goals/trace-schema-models/README.md)
  (inherits a copy of this ledger at `research/SOURCES.md`).
