...
const SystemErrorReason = S.Literals([
  "reason1",
  "reason2"
]);

// Platform error with context
class SystemError extends S.TaggedError<SystemError>()(
  "SystemError",
  {
...
export const SystemErrorReason = S.Literals([
  "AlreadyExists",
  "BadResource",
  "Busy",
  "InvalidData",
  ...
  "WouldBlock",
  "WriteZero",
]).annotate({ identifier: "SystemErrorReason",
...
export const HttpClientErrorReason = S.Literals([
...
]).annotate({ identifier: "HttpClientErrorReason",
...
export const EncodingErrorReason = S.Literals([
  "Decode", // Failed to decode from format
  "Encode", // Failed to encode to format
]).annotate({ identifier: "EncodingErrorReason",
...
export const HttpErrorReason = S.Literals([
  "BadRequest",
  "Unauthorized",
  "Forbidden",
  "NotFound",
  ...
  "BadGateway",
  "ServiceUnavailable",
]).annotate({ identifier: "HttpErrorReason",
...
export const ValidationErrorReason = S.Literals([
  "InvalidFormat",
  "OutOfRange",
  "Required",
  "TooLong",
  "TooShort",
]).annotate({ identifier: "ValidationErrorReason",
...
export class ResponseError extends S.TaggedError<ResponseError>()(
  "ResponseError",
  {
    reason: HttpClientErrorReason.pick([
      "StatusCode",
...
.annotate({ identifier: "HttpClientError",
    description: "A meaningful description"
  });
...
- [ ] Errors use appropriate pattern: S.TaggedError (discrimination)
