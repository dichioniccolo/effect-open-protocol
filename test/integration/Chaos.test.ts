 ...
 */
const runChaos = (options: { readonly seed: number; readonly devices: number; readonly faultRate: number }) =>
  Effect.gen(function* () {
...
describe("chaos invariant", () => {
  it.live(
    "loses nothing and delivers nothing twice",
    () =>
      Effect.gen(function* () {
