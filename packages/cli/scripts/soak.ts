...
import { DeviceId, DevicePool, Endpoint, type TighteningResult } from "effect-open-protocol"
...
import { layerSimulated } from "effect-open-protocol/simulator/SimulatorNetwork.ts"
